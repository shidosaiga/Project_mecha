                ...
                <tbody>
                  <tr>
                    ...
                    <div class="categories-table-img">
                        <img src="{{asset('admin/img/MeCha/icon_mecha.png')}}" alt="category">
                        </div>
                    </td>
                    <td>
                    : 25.บาท 
                    ...
                    <td>
                          ...
                          <li style="color:orange"><a href="{{route('edithomepage')}}">Edit</a></li>
                          <li style="color:red;"><a href="##">Delete</a></li>                        
